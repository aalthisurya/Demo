...
namespace VRTK
{
    ...
    public class VRTK_StraightPointerRenderer : VRTK_BasePointerRenderer
    {
		...
		public Vector3 TempPost;
		public Transform Quat;
        ...
        protected virtual void CheckRayHit(bool rayHit, RaycastHit pointerCollidedWith)
        {
			...
			TempPost = pointerCollidedWith.point;
...
#pragma warning restore 0618
        ...
        protected virtual void SetPointerAppearance(float tracerLength)
        {
            if (actualContainer)
            {
				...
				Quat = actualCursor.transform;


//				print ("TTTTTTTTTTTTTTTTRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRR : " + Quat.transform.eulerAngles);
				print ("122222222222222222223333333333333333333333333333333333333333333333333333333333333333333333333333333333333" + actualCursor.transform.eulerAngles);
            }
        }
    }
